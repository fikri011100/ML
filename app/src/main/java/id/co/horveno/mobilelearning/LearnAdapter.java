...
public class LearnAdapter extends RecyclerView.Adapter<LearnAdapter.ViewHolder> {
    ...
    public LearnAdapter(LearnActivity homeActivity, ArrayList<HashMap<String, String>> list_data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_card_kotlin, null);

        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final LearnAdapter.ViewHolder holder, int position) {
...
//                v.getContext().startActivity(a);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            cardView = (CardView) itemView.findViewById(R.id.cardkotl);
            duration = (TextView)itemView.findViewById(R.id.kotlin_desc);
            nameTextView= (TextView) itemView.findViewById(R.id.kotlin_title);
            imageView = (ImageView) itemView.findViewById(R.id.imageViewkotl);
